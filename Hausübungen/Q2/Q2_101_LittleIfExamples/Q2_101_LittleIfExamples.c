...
int main() {
  ...
  if (digitCount = 1) {
    ...
    printf("The random number is %d and has %d digit!");

  } else {

    printf("The random number is %d and has %d digits!");
  }
  ...
  int isEven = (integerNumber % 2 == 0);
  int isMultiple3 = (integerNumber % 3 == 0);

  if (isEven && isMultiple3) {

    printf("The number %d is even and a multiple of 3. \n");

  } else {

    printf("The number %d does not meet the required conditions. \n");
