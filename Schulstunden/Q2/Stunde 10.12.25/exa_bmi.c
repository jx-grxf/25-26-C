...
int main() {
  ...
  printf("Bitte geben sie ihre Groesse in m ein: ");
  scanf("%f", &groesse);
  ...
  printf("Bitte geben sie ihr biologisches Geschlecht ein: ");
  scanf(" %c", &geschlecht);
  ...
  bmi_wert = gewicht / (groesse * groesse);

  printf("\nDer errechnete BMI-Wert betägt %f\n", bmi_wert);
  ...
  if (geschlecht == 'w') {
    ...
    if (alter >= 19 && alter <= 24) {
      ...
      if (bmi_wert <= 18) {
        ...
        printf("Dieser BMI_Wert fällt unter starke Adipositas!\n");
